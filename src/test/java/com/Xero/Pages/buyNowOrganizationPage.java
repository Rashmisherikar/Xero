...
public class buyNowOrganizationPage extends XeroBaseClass{

	WebDriver driver;
	public buyNowOrganizationPage(WebDriver driver) {
		this.driver = driver;
	...
	public void StartXeroBuyTrial() throws InterruptedException {
